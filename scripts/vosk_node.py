...
class vosk_sr():
    def __init__(self):
        ...
        model = "vosk-model-en-us-0.42-gigaspeech" #change the name of the model to match the downloaded model's name
    ...
    def listen_or_not(self):
        rospy.Subscriber('/listen_or_not', Bool, self.tts_get_status)
